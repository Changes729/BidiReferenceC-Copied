 ...
 * 2013-Jun-21 kenw   Tweaks for uint32_t definition.
...
static char versionString[] = "bidiref version 13.0.0, 2020-03-27\n";
 ...
 */
extern int continueOnTestErr; /* Don't stop if test case fails. */
...
static void usageMsg( void )
{
    ...
    fputs ("       Default UBA version is 13.0.\n", stdout );
    ...
    fputs ("       -unn set UBA version to n.n. (valid values: -u62, -u63, -u70, -u80, -u90, -u100, -u110, -u120, -u130 )\n",
        stdout );
