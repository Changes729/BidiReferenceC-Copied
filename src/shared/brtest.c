...
static BIDIUNITPTR br_ConstructBidiUnitVector ( int len, uint32_t *text,
    int fileFormat )
{
BIDIUNITPTR bp;
BIDIUNITPTR tbp;
...
static UBACTXTPTR br_ConstructContext ( int len, uint32_t *text,
...
int br_ProcessOneTestCase ( int64_t testCaseNumber, uint32_t *text, int textLen,
...
int br_QueryOneTestCase ( uint32_t *text, int textLen,
