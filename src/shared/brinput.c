...
static uint32_t example1[ 6] __attribute__((unused)) = { C_L1, C_L1, C_WS1, C_AL1, C_AL1, C_ON2 };
static uint32_t example2[12] __attribute__((unused)) = { C_L1, C_RLE, C_L1, C_WS1, C_AL1, C_NSM,
                                C_ON2, C_EN1, C_PDF, C_L1, C_R1, C_WS1 };
static uint32_t example3[ 3] __attribute__((unused)) = { C_LRE, C_PDF, C_L1 };
static uint32_t example4[12] __attribute__((unused)) = { C_ON2, C_LRE, C_ON4, C_RLI, C_L1, C_PDI,
                                C_ON1, C_PDF, C_ET1, C_NSM, C_BN1, C_AL1 };
static uint32_t example5[13] __attribute__((unused)) = { C_R1, C_RLI, C_L1, C_LRI, C_L1, C_RLE, C_L1,
                                C_PDF, C_L1, C_PDI, C_L1, C_PDI, C_L1 };
static uint32_t example6[13] __attribute__((unused)) = { C_ON2, C_ON3, C_ON4, C_ON5, C_L1, C_ON3,
                                C_ON1, C_ON4, C_ET1, C_NSM, C_ON6, C_AL1, C_AN1 };
static uint32_t example7[ 4] __attribute__((unused))= { C_ON3, C_L1, C_ON4, C_L1 };
static uint32_t example8[ 2] __attribute__((unused))= { C_LRE, C_LRI };
static uint32_t example9[ 2] __attribute__((unused))= { C_RLI, C_R1 };
static uint32_t example10[4] __attribute__((unused)) = { C_R1, C_RLI, C_PDF, C_R1 };
static uint32_t example11[4] __attribute__((unused)) = { C_FSI, C_LRI, C_PDI, C_R1 };
static uint32_t example12[13] __attribute__((unused)) = { C_ON2, C_ON3, C_ON4, C_ON5, C_L1, C_ON7,
                                C_ON1, C_ON8, C_ET1, C_NSM, C_ON6, C_AL1, C_AN1 };
static uint32_t example13[ 4] __attribute__((unused)) = { C_R1, C_ON3, C_EN1, C_ON4 };
static uint32_t example14[ 5] __attribute__((unused)) = { C_R1, C_LRI, C_RLE, C_PDI, C_R1 };
static uint32_t example15[ 5] __attribute__((unused)) = { C_R1, C_EN1, C_ON3, C_R1, C_ON4 };
...
static uint32_t *example = example15;
 ...
 * digit hex. Convert that into a vector of code points expressed as uint32_t
 * values. Calculate and return the length of the constructed vector.
 */

static int br_ConstructUInt32Vector ( char *input, uint32_t *output, int *len )
{
int tlen;
char *sp;
char *send;
 ...
 */
    ...
    while ( sp < send )
    {
        ...
        /*
         * Code point parsed o.k. Write into the uint32_t buffer
...
uint32_t text32[BR_MAXINPUTLEN];
int textLen;
...
static int br_ConstructUInt32VectorBC ( char *input, uint32_t *output, int len )
{
char *sp;
char *send;
uint32_t *dp;
 ...
 */
    ...
    while ( sp < send )
    {
        ...
        /*
         * Bidi_Class parsed o.k. Write into the uint32_t buffer.
         */
        *dp++ = bc;
    }
    return ( 1 );
