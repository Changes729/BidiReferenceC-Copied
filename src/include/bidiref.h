 ...
 * 2019-Nov-19 kenw   Add UBA120
 * 2020-Mar-26 kenw   Add UBA130
 */
...
extern void TraceOn ( uint32_t traceValue );
extern void TraceOff ( uint32_t traceValue );
...
extern int br_ProcessOneTestCase ( int64_t testCaseNumber, uint32_t *text, int textLen,
...
extern int br_QueryOneTestCase ( uint32_t *text, int textLen,
